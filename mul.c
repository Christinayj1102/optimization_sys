...
int main() {
    ...
    measure_performance(combine1, v, &result, "Combine1 (mul)");
    measure_performance(combine2, v, &result, "Combine2 (mul)");
    measure_performance(combine3, v, &result, "Combine3 (mul)");
    measure_performance(combine4, v, &result, "Combine4 (mul)");
